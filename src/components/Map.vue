...
export default {
  ...
  methods: {
    ...
    changeCoordinates() {
     // let start = Date.now();
      axios.get(constant.URL_BACKEND_HEROKU + '/entities/markers/updated', {params: {entity: this.entity}}).then(response => {
    ...
    createMarkersPatients() {
      axios.get(constant.URL_BACKEND_HEROKU + '/entities/patients/markers').then(response => {
        this.markers = response.data
        this.reverseGeocoding();
      });
    },
    createMarkersVehicles() {
      axios.get(constant.URL_BACKEND_HEROKU + '/entities/vehicles/markers').then(response => {
        this.markers = response.data
        this.reverseGeocoding();
      });
    },
      ...
      for (let i = 0; i < this.markers.length; i++) {
        service.reverseGeocode({
          ...
          result.items.forEach((item) => {
            axios.put(constant.URL_BACKEND_HEROKU + '/entities/markers/address', {id: this.markers[i].id, address: item.address.label, entity: this.entity});
          });
        });
      }
    },
    highlightMarkers(dataArray) {
      axios.put( constant.URL_BACKEND_HEROKU + '/entities/markers/highlight',  { data: dataArray, entity: this.entity}).catch(error => {
      ...
      if (data.criterion === 'tertile') {
        switch (data.text) {
          case 'Ergonomics':
            ...
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/tertile/ergonomics').then(response => {
              this.markers = response.data
            });
            break
          case 'Vibrations':
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/tertile/vibrations').then(response => {
              this.markers = response.data
            });
            break
          case 'Fuel':
            this.deselectAllMarkers()
            alert('The best criterion for this index is quartile!')
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/tertile/fuel').then(response => {
              this.markers = response.data
            });
            break
          case 'Noise':
            this.deselectAllMarkers()
            alert('The best criterion for this index is quartile!')
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/tertile/noise').then(response => {
              this.markers = response.data
            });
            break
          case 'Lace':
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/tertile/lace').then(response => {
              this.markers = response.data
            });
            break
          case 'Charlston':
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/tertile/charlston').then(response => {
              this.markers = response.data
            });
            break
          case 'ASA':
            alert('The best criterion for this index is quartile!')
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/tertile/asa').then(response => {
              this.markers = response.data
            });
            break
          case 'GMA':
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/tertile/gma').then(response => {
              this.markers = response.data
            });
            break
          case 'Barthel':
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/tertile/barthel').then(response => {
              this.markers = response.data
            });
            break
        }
        ...
        switch (data.text) {
          case 'Ergonomics':
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/quartile/ergonomics').then(response => {
              this.markers = response.data
            });
            break
          case 'Vibrations':
            ...
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/quartile/vibrations').then(response => {
              this.markers = response.data
            });
            break
          case 'Fuel':
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/quartile/fuel').then(response => {
              this.markers = response.data
            });
            break
          case 'Noise':
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/quartile/noise').then(response => {
              this.markers = response.data
            });
            break
          case 'Lace':
            this.deselectAllMarkers()
            alert('The best criterion for this index is tertile!')
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/quartile/lace').then(response => {
              this.markers = response.data
            });
            break
          case 'Charlston':
            this.deselectAllMarkers()
            alert('The best criterion for this index is tertile!')
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/quartile/charlston').then(response => {
              this.markers = response.data
            });
            break
          case 'ASA':
            this.deselectAllMarkers()
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/quartile/asa').then(response => {
              this.markers = response.data
            });
            break
          case 'GMA':
            this.deselectAllMarkers()
            alert('The best criterion for this index is tertile!')
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/quartile/gma').then(response => {
              this.markers = response.data
            });
            break
          case 'Barthel':
            this.deselectAllMarkers()
            alert('The best criterion for this index is tertile!')
            axios.get(constant.URL_BACKEND_HEROKU + '/entities/quartile/barthel').then(response => {
              this.markers = response.data
            });
            break
        }
        ...
        this.deselectAllMarkers()
        axios.get(constant.URL_BACKEND_HEROKU + '/entities/expression', {params: {criterion: data.criterion, entity: this.entity}}).then(response => {
          this.markers = response.data
        });
      }
    }
  ...
  created() {
    ...
    bus.$on('uncheckRadio',() => {
      ...
      axios.put(constant.URL_BACKEND_HEROKU + '/entities/markers/deselect', {entity: this.entity}).catch(error => {
