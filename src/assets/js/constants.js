export const URL_BACKEND_LOCAL = 'http://localhost:8000';
export const URL_BACKEND_HEROKU = 'http://localhost:8000'//'https://secure-brushlands-64092.herokuapp.com';
...
export const CENTER_OF_MAP = [39.984702,116.318417]; //Bejing
